...
import com.wy.repository.EnterpriseRepository;
...
public class EnterpriseServiceImpl {
	...
	public List<Enterprise> hotList() {
		List<Enterprise> list = enterpriseRepository.findByIshot("1");
		return list;
	}
	...
	private Specification<Enterprise> createSpecification(Map<String, Object> searchMap) {
		...
		return new Specification<Enterprise>() {
			...
			private static final long serialVersionUID = -4273730603751029672L;
