 ...
 *
 * @author 飞花梦影
 * @date 2021-04-21 09:16:08
 * @git {@link https://github.com/dreamFlyingFlower}
 */
@Api(tags = "通用控制层查询API")
public class QueryCrl<T, ID extends Serializable> implements BaseCrl {
	...
	@GetMapping("info/{id}")
	public Result<?> info(@ApiParam("数字主键编号") @PathVariable ID id) {
		return Result.ok(baseService.info(id));
	}
	 ...
	 * 
	 * @param t
	 *        实体类参数,若beginCreatetime,endCreatetime,beginUpdatetime,endUpdatetime有值,
	 *        则会和createtime,updatetime字段比较
